...
def get_backbone(args, pretrained=False):
    ...
    # SSF 
        ...
        if args["model_name"] == "aper_ssf"  or args["model_name"] == "ranpac" or args["model_name"] == "fecam" or args["model_name"] == 'incsar':
    ...
    # Coda_Prompt
        ...
        if args["model_name"] == "mos":
            ...
            if name == "vit_base_patch16_224_mos":
                ...
                raise NotImplementedError("Unknown type {}".format(name))
            return model
    elif 'sar_cnn' in name:
        from backbone.incsar import sar_cnn
        model = sar_cnn()
        model.out_dim= 1152
        return model.eval()
    else:
